-- V1: Initial schema creation for jobs and duduwa_aggregate_buildings
...
-- Create duduwa_aggregate_buildings table
CREATE TABLE duduwa_aggregate_buildings (
...
CREATE INDEX idx_duduwa_buildings_ward ON duduwa_aggregate_buildings(ward_number);
CREATE INDEX idx_duduwa_buildings_locality ON duduwa_aggregate_buildings(locality);
CREATE INDEX idx_duduwa_buildings_token ON duduwa_aggregate_buildings(building_token);
CREATE INDEX idx_duduwa_buildings_map_status ON duduwa_aggregate_buildings(map_status);
