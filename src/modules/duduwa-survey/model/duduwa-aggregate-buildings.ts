...
export const duduwaAggregateBuilding = pgTable('duduwa_aggregate_buildings', {
  // Primary identifier
...
export type duduwaAggregateBuilding =
  typeof duduwaAggregateBuilding.$inferSelect;

export type NewduduwaAggregateBuilding =
  typeof duduwaAggregateBuilding.$inferInsert;
