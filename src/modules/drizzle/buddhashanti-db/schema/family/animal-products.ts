...
export const buddhashantiAnimalProduct = pgTable('buddhashanti_animal_product', {
  id: varchar('id', { length: 48 }).primaryKey().notNull(),
...
export type buddhashantiAnimalProduct = typeof buddhashantiAnimalProduct.$inferSelect;
