...
export const stagingBusiness = pgTable('staging_duduwa_business', {
...
export const business = pgTable('duduwa_business', {
  id: varchar('id', { length: 48 }).primaryKey(),
...
export const businessEditRequests = pgTable('duduwa_business_edit_requests', {
  id: varchar('id', { length: 48 }).primaryKey(),
...
export const businessWithUpdatedNames = pgTable(
  'duduwa_business_with_updated_names',
  {
    ...
    businessLocationOwnershipOther: varchar(
    ...
    totalPermanentEmployees: integer('total_permanent_employees'),
    nepaliMalePermanentEmployees: integer('nepali_male_permanent_employees'),
    nepaliFemalePermanentEmployees: integer(
    ...
    totalTemporaryEmployees: integer('total_temporary_employees'),
    nepaliMaleTemporaryEmployees: integer('nepali_male_temporary_employees'),
    nepaliFemaleTemporaryEmployees: integer(
...
export type BusinessWithUpdatedNames =
  typeof businessWithUpdatedNames.$inferSelect;
