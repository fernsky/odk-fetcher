...
export const stagingBuildings = pgTable('staging_duduwa_buildings', {
...
export const buildings = pgTable('duduwa_buildings', {
  id: varchar('id', { length: 48 }).primaryKey(), // Unique identifier for the record
  surveyDate: timestamp('survey_date'),
  enumeratorName: varchar('enumerator_name', { length: 255 }),
...
export const buildingEditRequests = pgTable('duduwa_building_edit_requests', {
...
export const buildingTokens = pgTable('duduwa_building_tokens', {
...
export const buildingsWithUpdatedNames = pgTable(
  'duduwa_buildings_with_updated_names',
  {
