...
export const stagingduduwaIndividual = pgTable('staging_duduwa_individual', {
...
export const duduwaIndividual = pgTable('duduwa_individual', {
...
export type duduwaIndividual = typeof duduwaIndividual.$inferSelect;
export type StagingduduwaIndividual =
  typeof stagingduduwaIndividual.$inferSelect;
