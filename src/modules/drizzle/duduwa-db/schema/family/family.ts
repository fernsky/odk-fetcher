...
export const stagingFamily = pgTable('staging_duduwa_family', {
...
export const family = pgTable('duduwa_family', {
  id: text('id').primaryKey().notNull(),
...
export const familyEditRequests = pgTable('duduwa_family_edit_requests', {
...
export const familyWithUpdatedNames = pgTable(
  'duduwa_family_with_updated_names',
  {
    id: text('id'),
    enumeratorName: text('enumerator_name'),
