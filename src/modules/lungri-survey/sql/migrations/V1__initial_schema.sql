-- V1: Initial schema creation for jobs and lungri_aggregate_buildings
...
-- Create lungri_aggregate_buildings table
CREATE TABLE lungri_aggregate_buildings (
...
CREATE INDEX idx_lungri_buildings_ward ON lungri_aggregate_buildings(ward_number);
CREATE INDEX idx_lungri_buildings_locality ON lungri_aggregate_buildings(locality);
CREATE INDEX idx_lungri_buildings_token ON lungri_aggregate_buildings(building_token);
CREATE INDEX idx_lungri_buildings_map_status ON lungri_aggregate_buildings(map_status);
