-- V1: Initial schema creation for jobs and gadhawa_aggregate_buildings
...
-- Create gadhawa_aggregate_buildings table
CREATE TABLE gadhawa_aggregate_buildings (
...
CREATE INDEX idx_gadhawa_buildings_ward ON gadhawa_aggregate_buildings(ward_number);
CREATE INDEX idx_gadhawa_buildings_locality ON gadhawa_aggregate_buildings(locality);
CREATE INDEX idx_gadhawa_buildings_token ON gadhawa_aggregate_buildings(building_token);
CREATE INDEX idx_gadhawa_buildings_map_status ON gadhawa_aggregate_buildings(map_status);
