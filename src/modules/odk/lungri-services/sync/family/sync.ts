...
import {
  ...
  users,
  wards,
} from '@app/modules/drizzle/lungri-db/schema';
import {
  family,
  stagingFamily,
} from '@app/modules/drizzle/lungri-db/schema/family/family';
import {
  staginglungriIndividual,
  lungriIndividual,
} from '@app/modules/drizzle/lungri-db/schema/family/individual';
import {
  staginglungriDeath,
  lungriDeath,
} from '@app/modules/drizzle/lungri-db/schema/family/deaths';
import {
  staginglungriCrop,
  lungriCrop,
} from '@app/modules/drizzle/lungri-db/schema/family/crops';
import {
  staginglungriAnimal,
  lungriAnimal,
} from '@app/modules/drizzle/lungri-db/schema/family/animals';
import {
  staginglungriAnimalProduct,
  lungriAnimalProduct,
} from '@app/modules/drizzle/lungri-db/schema/family/animal-products';

import { StaginglungriDeath } from '@app/modules/drizzle/lungri-db/schema/family/deaths';
import lungriAgriculturalLand, {
  staginglungriAgriculturalLand,
} from '@app/modules/drizzle/lungri-db/schema/family/agricultural-lands';
...
async function performFamilySync(ctx: any, recordId: string) {
  try {
    ...
    await ctx.db.transaction(async (tx: any) => {
      ...
      // Insert animals
      if (animals.length > 0) {
        await tx.insert(lungriAnimal).values(animals).onConflictDoNothing();
      }
