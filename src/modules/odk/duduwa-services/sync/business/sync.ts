...
import {
  business,
  stagingBusiness,
} from '@app/modules/drizzle/duduwa-db/schema/business/business';
import {
  businessCrops,
  StagingBusinessCrop,
  stagingBusinessCrops,
} from '@app/modules/drizzle/duduwa-db/schema/business/business-crops';
import {
  businessAnimalProducts,
  StagingBusinessAnimalProduct,
  stagingBusinessAnimalProducts,
} from '@app/modules/drizzle/duduwa-db/schema/business/business-animal-products';
import {
  businessAnimals,
  StagingBusinessAnimal,
  stagingBusinessAnimals,
} from '@app/modules/drizzle/duduwa-db/schema/business/business-animals';
...
async function performBusinessSync(ctx: any, recordId: string) {
  try {
    ...
    await ctx.db
      ...
      .values({
        staging_table: 'staging_duduwa_buildings',
        production_table: 'duduwa_buildings',
        recordId: recordId,
      })
      .onConflictDoNothing();
  } catch (error) {
