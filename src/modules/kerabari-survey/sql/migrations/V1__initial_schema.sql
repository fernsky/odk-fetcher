-- V1: Initial schema creation for jobs and kerabari_aggregate_buildings
...
-- Create kerabari_aggregate_buildings table
CREATE TABLE kerabari_aggregate_buildings (
...
CREATE INDEX idx_kerabari_buildings_ward ON kerabari_aggregate_buildings(ward_number);
CREATE INDEX idx_kerabari_buildings_locality ON kerabari_aggregate_buildings(locality);
CREATE INDEX idx_kerabari_buildings_token ON kerabari_aggregate_buildings(building_token);
CREATE INDEX idx_kerabari_buildings_map_status ON kerabari_aggregate_buildings(map_status);
